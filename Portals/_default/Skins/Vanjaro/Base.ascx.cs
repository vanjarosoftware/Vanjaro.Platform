...
#pragma warning restore CS0162 // Unreachable code detected
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(Request.QueryString["mid"]) || (!string.IsNullOrEmpty(Request.QueryString["icp"]) && bool.Parse(Request.QueryString["icp"]) && (!string.IsNullOrEmpty(Request.QueryString["mid"]) && Request.QueryString["mid"] != "0")))
            {
                ...
                WebForms.LinkCSS(Page, "ThemeCSS", Page.ResolveUrl("~/Portals/" + PortalSettings.PortalId + "/vThemes/" + Core.Managers.ThemeManager.GetCurrent().ThemeName + "/Theme.css"));
                ...
                WebForms.RegisterClientScriptBlock(Page, "DefaultPath", "var VjThemePath='" + Page.ResolveUrl("~/Portals/_default/vThemes/" + Core.Managers.ThemeManager.GetCurrent().ThemeName) + "'; var VjDefaultPath='" + Page.ResolveUrl("~/DesktopModules/Vanjaro/UXManager/Library/Resources/Images/") + "'; var VjSitePath='" + Page.ResolveUrl("~/DesktopModules/Vanjaro/") + "';", true);
                ...
                string DirectoryPath = System.Web.Hosting.HostingEnvironment.MapPath("~/Portals/_default/vThemes/" + Core.Managers.ThemeManager.GetCurrent().ThemeName + "/js/");
                ...
                {
                    string ThemeJS = "~/Portals/_default/vThemes/" + Core.Managers.ThemeManager.GetCurrent().ThemeName + "/theme.js";
        ...
        private void AddModulePanes()
        {
            ...
            {
                string Content = Core.Managers.ThemeManager.GetCurrent().EditLayout;
