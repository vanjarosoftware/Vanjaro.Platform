...
(function (ng, undefined) {
    ...
    ng.module('smart-table', []).run(['$templateCache', function ($templateCache) {
        $templateCache.put('template/smart-table/pagination.html',
            ...
            '<li ng-repeat="page in pages" class="page-item"><a class="page-link" ng-click="selectPage(page)" ng-class="{active: page==currentPage}">{{page}}</a></li>' +
            '</ul></nav>');
    }]);
    ...
    ng.module('smart-table')
      .constant('stConfig', {
          ...
          sort: {
              ascentClass: 'ms-glyphicon ms-glyphicon-arrow-up',
              descentClass: 'ms-glyphicon ms-glyphicon-arrow-down',
              skipNatural: false
          },
          pipe: {
              delay: 100 //ms
