...
mnSvc.directive('uiengine', ['$compile', '$timeout', 'CommonSvc', '$routeParams', '$rootScope', '$route', function ($compile, $timeout, CommonSvc, $routeParams, $rootScope, $route) {
    var linker = function ($scope, $element, $attrs) {
        ...
        $scope.GetFields = function () {
            ...
            if ($scope.csv.result != undefined && $scope.csv.result.length > 0) {
                ...
                $.each($scope.ui.data.DataFields.Options, function (key, Field) {
                    ...
                    if (Field.IsHeader) {
                        ...
                        if (IsFirst)
                            Rows += "<div class=\"accordion-header\" style=\"margin-top: 5px;border: 1px solid rgba(0, 0, 0, 0.125);\"><button class=\"accordion-button\" data-bs-toggle=\"collapse\" style=\"\" data-bs-target=\"#" + Field.Name + "\" onClick=\"return false;\">" + Field.DisplayName + "<em class=\"fas fa-caret-down float-end \"></em></button></div><div id=" + Field.Name + " style=\"border: 1px solid rgba(0, 0, 0, 0.125);border-top: 0;background-color: white;    padding-bottom: 20px;border-bottom-left-radius: 5px;border-bottom-right-radius: 5px;\" class=\"accordion-collapse collapse show\">";
                        else
                            Rows += "<div class=\"accordion-header\" style=\"margin-top: 5px;border: 1px solid rgba(0, 0, 0, 0.125);\"><button class=\"accordion-button\" data-bs-toggle=\"collapse\" style=\"\" data-bs-target=\"#" + Field.Name + "\" onClick=\"return false;\">" + Field.DisplayName + "<em class=\"fas fa-caret-down float-end \"></em></button></div><div id=" + Field.Name + " style=\"border: 1px solid rgba(0, 0, 0, 0.125);border-top: 0;background-color: white;    padding-bottom: 20px;border-bottom-left-radius: 5px;border-bottom-right-radius: 5px;\" class=\"accordion-collapse collapse\">";
            ...
            return "<div class=\"container\"><div class=\"accordion\"><div class=\"accordion-itembox\" style=\"\">" + Rows + "</div></div></div>";
        };
