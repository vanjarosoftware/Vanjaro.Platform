    ...
    public class Language : Core.Entities.Interface.IBlock, IExtension
    {
        ...
        private string GenerateMarkup(Dictionary<string, string> Attributes)
        {
            try
            {
                ...
                if (HttpContext.Current != null && HttpContext.Current.Request.Cookies["vj_IsPageEdit"] != null && !string.IsNullOrEmpty(HttpContext.Current.Request.Cookies["vj_IsPageEdit"].Value))
                {
