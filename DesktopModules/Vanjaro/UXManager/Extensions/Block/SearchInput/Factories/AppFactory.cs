...
namespace Vanjaro.UXManager.Extensions.Block.SearchInput.Factories
{
    public class AppFactory
    {
        ...
        internal static List<AngularView> GetViews()
        {
            ...
            AngularView setting_searchinput = new AngularView
            {
                AccessRoles = "admin",
                ...
                TemplatePath = "setting/searchinput.html",
                Identifier = Identifier.setting_searchinput.ToString(),
                Defaults = new Dictionary<string, string> { }
            };
            Views.Add(setting_searchinput);
            return Views;
        }
