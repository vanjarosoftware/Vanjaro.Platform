...
namespace Vanjaro.UXManager.Extensions.Block.Register.Factories
{
    public class AppFactory
    {
        ...
        internal static List<AngularView> GetViews()
        {
            ...
            AngularView setting_register = new AngularView
            {
                ...
                TemplatePath = "setting/register.html",
                Identifier = Identifier.setting_register.ToString(),
                Defaults = new Dictionary<string, string> { }
            };
            Views.Add(setting_register);
            return Views;
        }
