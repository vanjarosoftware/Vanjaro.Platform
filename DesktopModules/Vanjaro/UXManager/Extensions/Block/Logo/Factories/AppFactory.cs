...
namespace Vanjaro.UXManager.Extensions.Block.Logo.Factories
{
    public class AppFactory
    {
        ...
        internal static List<AngularView> GetViews()
        {
            ...
            AngularView setting_logo = new AngularView
            {
                AccessRoles = "admin",
                ...
                TemplatePath = "setting/logo.html",
                Identifier = Identifier.setting_logo.ToString(),
                Defaults = new Dictionary<string, string> { }
            };
            Views.Add(setting_logo);
            return Views;
        }
