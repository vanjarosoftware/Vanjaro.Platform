...
namespace Vanjaro.UXManager.Extensions.Toolbar.Navigator
{
    public class Navigator : IToolbarItem
    {
        ...
        public string Icon => "fas fa-layer-group";
        ...
        public Dictionary<MenuAction, dynamic> ToolbarAction
        {
            get
            {
                Dictionary<MenuAction, dynamic> Event = new Dictionary<MenuAction, dynamic>
                {
                    ...
                    { MenuAction.onClick, "$(\"#layer-manager\").toggle();" }
                };
                return Event;
            }
        }
