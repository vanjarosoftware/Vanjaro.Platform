...
namespace Vanjaro.UXManager.Extensions.Toolbar.Navigator.Factories
{
    public class AppFactory
    {
        ...
        {
            return new AppInformation("Navigator", "Navigator", ExtensionInfo.GUID, GetRuntimeVersion, "http://www.mandeeps.com/store", "http://www.mandeeps.com/Activation", 14, 7, new List<string> { "Domain", "Server" }, false);
        }
