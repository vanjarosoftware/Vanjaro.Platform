...
namespace Vanjaro.UXManager.Extensions.Toolbar.Redo
{
    public class Redo : IToolbarItem
    {
        ...
        public string Icon => "fas fa-redo";
        ...
        public Dictionary<MenuAction, dynamic> ToolbarAction
        {
            get
            {
                ...
                {
                    { MenuAction.onClick, "VjEditor.UndoManager.redo();" }
                };
                return Event;
            }
        }
