...
namespace Vanjaro.UXManager.Extensions.Toolbar.Language.Factories
{
    public class AppFactory
    {
        ...
        {
            return new AppInformation("Language", "Language", ExtensionInfo.GUID, GetRuntimeVersion, "http://www.mandeeps.com/store", "http://www.mandeeps.com/Activation", 14, 7, new List<string> { "Domain", "Server" }, false);
        }
