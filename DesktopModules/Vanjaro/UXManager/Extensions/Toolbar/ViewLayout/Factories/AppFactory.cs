...
namespace Vanjaro.UXManager.Extensions.Toolbar.ViewLayout.Factories
{
    public class AppFactory
    {
        ...
        {
            return new AppInformation("ViewLayout", "ViewLayout", ExtensionInfo.GUID, GetRuntimeVersion, "http://www.mandeeps.com/store", "http://www.mandeeps.com/Activation", 14, 7, new List<string> { "Domain", "Server" }, false);
        }
