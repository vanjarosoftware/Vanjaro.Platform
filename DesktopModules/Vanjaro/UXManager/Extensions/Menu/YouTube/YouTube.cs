...
using Vanjaro.UXManager.Extensions.Menu.YouTube.Components;
using Vanjaro.UXManager.Extensions.Menu.YouTube.Factories;
...
namespace Vanjaro.UXManager.Extensions.Menu.YouTube
{
    public class YouTube : IMenuItem
    {
        public List<MenuItem> Items
        {
            get
            {
                ...
                ListItems.Add(new MenuItem
                {
                    ...
                    Text = Localization.Get("YouTube", "Text", Constants.LocalResourcesFile, Extension.ShowMissingKeysStatic, Localization.SharedMissingPrefix),
