...
namespace Vanjaro.UXManager.Extensions.Menu.Domain.Controllers
{
    public class UIController : UIEngineController
    {
        public override List<IUIData> GetData(string Identifier, Dictionary<string, string> Parameters)
        {
            ...
            {
                case AppFactory.Identifier.domain_domains:
                    return DomainController.GetData(Identifier, Parameters, UIEngineInfo, UserInfo, PortalSettings);
                case AppFactory.Identifier.domain_settings:
                    return DomainController.GetData(Identifier, Parameters, UIEngineInfo, UserInfo, PortalSettings);
                default:
                    break;
            }
