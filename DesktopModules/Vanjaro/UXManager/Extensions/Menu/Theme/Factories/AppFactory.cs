...
namespace Vanjaro.UXManager.Extensions.Menu.Theme.Factories
{
    public class AppFactory
    {
        ...
        {
            return new AppInformation(ThemeInfo.Name, ThemeInfo.FriendlyName, ThemeInfo.GUID, GetRuntimeVersion, "http://www.mandeeps.com/store", "http://www.mandeeps.com/Activation", 14, 7, new List<string> { "Domain", "Server" }, false);
        }
