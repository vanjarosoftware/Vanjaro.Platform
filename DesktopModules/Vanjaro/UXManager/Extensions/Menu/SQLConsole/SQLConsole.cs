...
using Vanjaro.UXManager.Extensions.Menu.SQLConsole.Components;
...
namespace Vanjaro.UXManager.Extensions.Menu.SQLConsole
{
    public class SQLConsole : IMenuItem
    {
        ...
        public List<MenuItem> Items
        {
            get
            {
                ...
                {
                    Text = Localization.Get("SQLConsole", "Text", Constants.LocalResourcesFile, Library.Extension.ShowMissingKeysStatic, Localization.SharedMissingPrefix),
