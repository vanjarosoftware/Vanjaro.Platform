...
namespace Vanjaro.UXManager.Extensions.Menu.Memberships.Factories
{
    public class AppFactory
    {
        ...
        public static List<AngularView> GetViews()
        {
            ...
            AngularView setting = new AngularView
            {
                ...
                TemplatePath = "memberships/settings.html",
                Identifier = Identifier.memberships_settings.ToString(),
        ...
        {
            return new AppInformation("Memberships", "Memberships", ExtensionInfo.GUID, GetRuntimeVersion, "http://www.mandeeps.com/store", "http://www.mandeeps.com/Activation", 14, 7, new List<string> { "Domain", "Server" }, false);
        }
