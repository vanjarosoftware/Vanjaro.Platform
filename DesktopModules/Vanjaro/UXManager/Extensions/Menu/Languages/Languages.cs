...
namespace Vanjaro.UXManager.Extensions.Menu.Languages
{
    public class Languages : IMenuItem
    {
        ...
        public List<MenuItem> Items
        {
            get
            {
                ...
                {
                    Text = Localization.Get("Languages", "Text", Constants.LocalResourcesFile, Library.Extension.ShowMissingKeysStatic, Localization.SharedMissingPrefix),
