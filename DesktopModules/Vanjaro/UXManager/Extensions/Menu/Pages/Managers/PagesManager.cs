        ...
        public class PagesManager
        {
            ...
            internal static List<Layout> GetLayouts()
            {
                ...
                if (layouts == null)
                {
                    ...
                    {
                        HttpContext.Current.Server.MapPath("~/Portals/_default/vThemes/" + ThemeManager.GetCurrent().Name + "/templates/pages/"),
                        HttpContext.Current.Server.MapPath("~/Portals/" + PortalSettings.Current.PortalId + "/vThemes/" + ThemeManager.GetCurrent().Name + "/templates/pages/")
                    };
            ...
            {
                string FolderPath = HttpContext.Current.Server.MapPath("~/Portals/" + PortalSettings.Current.PortalId + "/vThemes/" + ThemeManager.GetCurrent().Name + "/templates/pages/");
                if (Directory.Exists(FolderPath))
                {
            ...
            public static ActionResult SaveLayoutAs(int pid, string name, dynamic Data, PortalSettings PortalSettings)
            {
                ...
                try
                {
                    ...
                    if (data != null)
                    {
                        ...
                        string FolderPath = HttpContext.Current.Server.MapPath("~/Portals/" + PortalId + "/vThemes/" + ThemeManager.GetCurrent().Name + "/templates/pages/");
                        if (!Directory.Exists(FolderPath))
