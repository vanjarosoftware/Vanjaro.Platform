...
namespace Vanjaro.UXManager.Extensions.Menu.Logs.Controllers
{
    public class UIController : UIEngineController
    {
        public override List<IUIData> GetData(string Identifier, Dictionary<string, string> Parameters)
        {
            ...
            {
                case AppFactory.Identifier.setting_logs:
                    return LogsController.GetData(Identifier, Parameters, UserInfo, PortalSettings);
                case AppFactory.Identifier.setting_email:
                    return EmailController.GetData(Identifier, Parameters, UserInfo, PortalSettings);
                default:
                    break;
            }
