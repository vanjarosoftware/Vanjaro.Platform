...
using Vanjaro.UXManager.Extensions.Menu.Pixabay.Components;
using Vanjaro.UXManager.Extensions.Menu.Pixabay.Factories;
...
namespace Vanjaro.UXManager.Extensions.Menu.Pixabay
{
    public class Pixabay : IMenuItem
    {
        public List<MenuItem> Items
        {
            get
            {
                ...
                {
                    Text = Localization.Get("Pixabay", "Text", Constants.LocalResourcesFile, Extension.ShowMissingKeysStatic, Localization.SharedMissingPrefix),
