...
using Vanjaro.UXManager.Extensions.Menu.GoogleTagManager.Components;
...
{
    public class GoogleTagManager : IMenuItem
    {
        public List<MenuItem> Items
        {
            get
            {
                ...
                {
                    Text = Localization.Get("GoogleTagManager", "Text", Constants.LocalResourcesFile, Extension.ShowMissingKeysStatic, Localization.SharedMissingPrefix),
