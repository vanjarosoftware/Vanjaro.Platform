...
using Vanjaro.UXManager.Extensions.Menu.Azure.Factories;
    ...
    public class Azure : IMenuItem
    {
        ...
        public List<MenuItem> Items
        {
            get
            {
                ...
                {
                    Text = Localization.Get("Azure", "Text", Constants.LocalResourceFile, Extension.ShowMissingKeysStatic, Localization.SharedMissingPrefix),
                    ItemGuid = Guid.Parse(ExtensionInfo.GUID),
                    Icon = "fab fa-microsoft",
                    ViewOrder = 600,
                    Hierarchy = new MenuItem
                    {
                        Text = Localization.Get("Settings", "Text", Constants.LocalResourceFile, Extension.ShowMissingKeysStatic, Localization.SharedMissingPrefix),
                        Icon = "fas fa-cog",
                        Hierarchy = new MenuItem
                        {
                            Text = Localization.Get("Integration", "Text", Constants.LocalResourceFile, Extension.ShowMissingKeysStatic, Localization.SharedMissingPrefix),
                            Icon = "fas fa-plug"
                        }
                    }
                });
        ...
        public string SearchKeywords => Localization.Get("SearchKeywords", "Text", Constants.LocalResourceFile, Extension.ShowMissingKeysStatic, Localization.SharedMissingPrefix);
