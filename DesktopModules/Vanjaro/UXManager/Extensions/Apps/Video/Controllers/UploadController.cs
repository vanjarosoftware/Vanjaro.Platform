...
using Vanjaro.UXManager.Extensions.Apps.Video.Factories;
...
namespace Vanjaro.UXManager.Extensions.Apps.Video.Controllers
{
    ...
    public class UploadController : UIEngineController
    {
        ...
        {
            return BrowseUploadFactory.GetFoldersChildrensTree(PortalSettings.PortalId, folderid, UserInfo, "video");
        }
