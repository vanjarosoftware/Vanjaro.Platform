...
namespace Vanjaro.UXManager.Extensions.Apps.Image.Entities
{
    public static class FileSetting
    {
        public static long FileSize
        {
            get
            {
                ...
                {
                    return MaxUploadSize = Convert.ToInt64(Convert.ToDouble(settings.Where(s => s.Name == "Picture_MaxUploadSize").FirstOrDefault().Value));
                }
                else
                {
