				...
				traits: [
					{
						...
						type: 'preset_radio',
						options: [
							{ id: 'button-style-1', name: 'Style 1', class: 'button-style-1', DisplayName: 'Style A' },
							{ id: 'button-style-2', name: 'Style 2', class: 'button-style-2', DisplayName: 'Style B' },
							{ id: 'button-style-3', name: 'Style 3', class: 'button-style-3', DisplayName: 'Style C' },
							{ id: 'button-style-4', name: 'Style 4', class: 'button-style-4', DisplayName: 'Style D' },
							{ id: 'button-style-5', name: 'Style 5', class: 'button-style-5', DisplayName: 'Style E' },
							{ id: 'button-style-6', name: 'Style 6', class: 'button-style-6', DisplayName: 'Style F' },
							{ id: 'button-style-7', name: 'Style 7', class: 'button-style-7', DisplayName: 'Style G' },
							{ id: 'button-style-8', name: 'Style 8', class: 'button-style-8', DisplayName: 'Style H' },
							{ id: 'button-style-9', name: 'Style 9', class: 'button-style-9', DisplayName: 'Style I' },
							{ id: 'button-style-10', name: 'Style 10', class: 'button-style-10', DisplayName: 'Style J' },
						],
						default: 'Style 1',
						changeProp: 1,
					}
