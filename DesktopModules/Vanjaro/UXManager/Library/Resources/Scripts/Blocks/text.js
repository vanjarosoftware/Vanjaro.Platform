				...
				traits: [
					{
						...
						type: 'preset_radio',
						options: [
							{ id: 'paragraph-style-1', name: 'Style A', class: 'paragraph-style-1' },
							{ id: 'paragraph-style-2', name: 'Style B', class: 'paragraph-style-2' },
							{ id: 'paragraph-style-3', name: 'Style C', class: 'paragraph-style-3' },
							{ id: 'paragraph-style-4', name: 'Style D', class: 'paragraph-style-4' },
							{ id: 'paragraph-style-5', name: 'Style E', class: 'paragraph-style-5' },
							{ id: 'paragraph-style-6', name: 'Style F', class: 'paragraph-style-6' },
							{ id: 'paragraph-style-7', name: 'Style G', class: 'paragraph-style-7' },
							{ id: 'paragraph-style-8', name: 'Style H', class: 'paragraph-style-8' },
							{ id: 'paragraph-style-9', name: 'Style I', class: 'paragraph-style-9' },
							{ id: 'paragraph-style-10', name: 'Style J', class: 'paragraph-style-10' },
						],
						default: 'Style A',
						changeProp: 1,
					}
