				...
				traits: [
					{
						...
						options: [ 
                            { id: 'primary', name: 'Primary', class: 'border-primary' },
                            { id: 'secondary', name: 'Secondary', class: 'border-secondary' },
                            { id: 'tertiary', name: 'Tertiary', class: 'border-tertiary' },
                            { id: 'quaternary', name: 'Quaternary', class: 'border-quaternary' },
                            { id: 'success', name: 'Success', class: 'border-success' },
                            { id: 'info', name: 'Info', class: 'border-info' },
                            { id: 'warning', name: 'Warning', class: 'border-warning' },
                            { id: 'danger', name: 'Danger', class: 'border-danger' },
                            { id: 'light', name: 'Light', class: 'border-light' },
                            { id: 'dark', name: 'Dark', class: 'border-dark' },
						],
                        value: 'primary',
                        changeProp: 1,
					}
