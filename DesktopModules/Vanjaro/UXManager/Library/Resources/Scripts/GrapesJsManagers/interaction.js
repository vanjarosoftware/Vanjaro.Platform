...
$(document).ready(function () {
    ...
    if (toolitems > 6) {
        ...
        $('.ToolbarItem').prepend("<div class='ntoolbox'></div><ul class='more_icons'><li class='openbtn' data-bs-toggle='tooltip'  data-bs-placement='right'  title=\"" + VjLocalized.ShowHiddenIcons + "\"><em class='fas fa-chevron-up'></em></li></ul>");
