...
<head runat="server">	
    ...
    <link rel="stylesheet" type="text/css" href="../Resources/Shared/stylesheets/vcustom.css?refresh" />	
    ...
    <form id="form1" runat="server">	
        ...
        <div class="install">	
            ...
            <div class="dnnForm dnnInstall dnnClear" id="dnnInstall" runat="server">	
                <asp:Label ID="lblIntroDetail" runat="Server" ResourceKey="" />	
            </div>	
