...
namespace Vanjaro.Core.Extensions.Workflow.Review
{
    public class Review : ICoreExtension, INotificationTask
    {
        ...
        public NotificationItem Hierarchy => new NotificationItem
        {
            ...
            URL = ServiceProvider.NavigationManager.NavigateURL("", "mid=0", "icp=true", "guid=33d8efed-0f1d-471e-80a4-6a7f10e87a42") + "#/review/" + Core.Components.Enum.WorkflowLogType.VJPage.ToString().ToLower()
        };
